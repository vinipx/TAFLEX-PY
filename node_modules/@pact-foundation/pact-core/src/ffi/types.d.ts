...
export type FfiConsumerFunctions = {
    ...
    pactffiWithMatchingRules(handle: FfiInteractionHandle, part: FfiInteractionPart, rules: string): boolean;
    pactffiWithMultipartFile(handle: FfiInteractionHandle, part: FfiInteractionPart, contentType: string, file: string, partName: string, boundary?: string): void;
