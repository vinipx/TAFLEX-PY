...
const asyncMessage = (ffi, interactionPtr, pactPtr, messageCount, index) => ({
    ...
    withMatchingRules: (rules) => ffi.pactffiWithMatchingRules(interactionPtr, types_1.INTERACTION_PART_REQUEST, rules),
    ...
    return {
        ...
        newSynchronousMessage: (description) => {
            ...
            return {
                ...
                withRequestMatchingRules: (rules) => ffi.pactffiWithMatchingRules(interactionPtr, types_1.INTERACTION_PART_REQUEST, rules),
                withResponseMatchingRules: (rules) => ffi.pactffiWithMatchingRules(interactionPtr, types_1.INTERACTION_PART_RESPONSE, rules),
        ...
        newInteraction: (interactionDescription) => {
            ...
            return (0, checkErrors_1.wrapAllWithCheck)({
                ...
                withRequestMatchingRules: (rules) => ffi.pactffiWithMatchingRules(interactionPtr, types_1.INTERACTION_PART_REQUEST, rules),
                withResponseMatchingRules: (rules) => ffi.pactffiWithMatchingRules(interactionPtr, types_1.INTERACTION_PART_RESPONSE, rules),
                withRequestMultipartBody: (contentType, filename, mimePartName, boundary) => {
                    if (boundary)
                        return (ffi.pactffiWithMultipartFile(interactionPtr, types_1.INTERACTION_PART_REQUEST, contentType, filename, mimePartName, boundary) === undefined);
                ...
                withResponseMultipartBody: (contentType, filename, mimePartName, boundary) => {
                    if (boundary)
                        return (ffi.pactffiWithMultipartFile(interactionPtr, types_1.INTERACTION_PART_REQUEST, contentType, filename, mimePartName, boundary) === undefined);
                    return (ffi.pactffiWithMultipartFile(interactionPtr, types_1.INTERACTION_PART_REQUEST, contentType, filename, mimePartName) === undefined);
                },
