...
export type ConsumerInteraction = PluginInteraction & {
    ...
    withRequestMultipartBody: (contentType: string, filename: string, mimePartName: string, boundary?: string) => boolean;
    ...
    withResponseMultipartBody: (contentType: string, filename: string, mimePartName: string, boundary?: string) => boolean;
};
