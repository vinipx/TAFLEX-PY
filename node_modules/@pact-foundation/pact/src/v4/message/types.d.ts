...
export type V4AsynchronousMessageBuilderFunc = (builder: V4AsynchronousMessageBuilder) => void;
export type V4MessageRequestBuilderFunc = (builder: V4SynchronousMessageWithRequestBuilder) => void;
export type V4MessageResponseBuilderFunc = (builder: V4SynchronousMessageWithResponseBuilder) => void;
...
export interface V4AsynchronousMessageWithPluginContents {
    ...
    startTransport(transport: string, address: string, config?: AnyJson): V4AsynchronousMessageWithTransport;
}
