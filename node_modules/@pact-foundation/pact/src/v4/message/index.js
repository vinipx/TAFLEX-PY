...
var UnconfiguredSynchronousMessage = /** @class */ (function () {
    ...
    UnconfiguredSynchronousMessage.prototype.withRequest = function (builder) {
...
var SynchronousMessageWithRequestBuilder = /** @class */ (function () {
    ...
    SynchronousMessageWithRequestBuilder.prototype.withMatchingRules = function (rules) {
...
var SynchronousMessageWithResponseBuilder = /** @class */ (function () {
    ...
    SynchronousMessageWithResponseBuilder.prototype.withMatchingRules = function (rules) {
        (0, matchingRules_1.validateRules)(rules);
        var ffiRules = (0, matchingRules_1.convertRulesToFFI)(rules);
...
var SynchronousMessageWithTransport = /** @class */ (function () {
    ...
    SynchronousMessageWithTransport.prototype.executeTest = function (integrationTest) {
        return __awaiter(this, void 0, void 0, function () {
            var val, error, request, response, e_1, matchingResults, errors, success, errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        request = this.interaction.getRequestContents();
                        response = this.interaction.getResponseContents();
...
var SynchronousMessageWithResponse = /** @class */ (function () {
    ...
    SynchronousMessageWithResponse.prototype.executeTest = function (integrationTest) {
        var res = executeNonTransportTest(this.pact, this.opts, this.interaction, integrationTest, this.cleanupFn);
        this.cleanupFn();
        return res;
    };
...
var executeNonTransportTest = function (pact, opts, interaction, integrationTest, cleanupFn) { return __awaiter(void 0, void 0, void 0, function () {
    var val, error, request, response, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                request = interaction.getRequestContents();
                response = interaction.getResponseContents();
...
function v4AsynchronousBodyHandler(handler) {
    return function (m) { return handler(m.contents.content); };
}
