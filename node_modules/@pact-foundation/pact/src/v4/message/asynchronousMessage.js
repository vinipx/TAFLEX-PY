...
var UnconfiguredAsynchronousMessage = /** @class */ (function () {
    function UnconfiguredAsynchronousMessage(pact, interaction, opts, cleanupFn) {
        this.pact = pact;
    ...
    UnconfiguredAsynchronousMessage.prototype.expectsToReceive = function (description, builder) {
    ...
    UnconfiguredAsynchronousMessage.prototype.given = function (state, parameters) {
        if (parameters) {
    ...
    UnconfiguredAsynchronousMessage.prototype.usingPlugin = function (config) {
    ...
    return UnconfiguredAsynchronousMessage;
}());
exports.UnconfiguredAsynchronousMessage = UnconfiguredAsynchronousMessage;
var AsynchronousMessageWithPlugin = /** @class */ (function () {
    function AsynchronousMessageWithPlugin(pact, message, opts, cleanupFn) {
        this.pact = pact;
        this.message = message;
        this.opts = opts;
        this.cleanupFn = cleanupFn;
    }
    AsynchronousMessageWithPlugin.prototype.expectsToReceive = function (description) {
        this.message.interaction.expectsToReceive(description);
        return this;
    };
    AsynchronousMessageWithPlugin.prototype.usingPlugin = function (config) {
        this.pact.addPlugin(config.plugin, config.version);
        return this;
    };
    AsynchronousMessageWithPlugin.prototype.withPluginContents = function (contents, contentType) {
...
var AsynchronousMessageBuilder = /** @class */ (function () {
    function AsynchronousMessageBuilder(pact, message, opts) {
        this.pact = pact;
        this.message = message;
        this.opts = opts;
    }
    AsynchronousMessageBuilder.prototype.withMetadata = function (metadata) {
        var _this = this;
        ...
        (0, ramda_1.forEachObjIndexed)(function (v, k) {
            _this.message.interaction.withMetadata("".concat(k), JSON.stringify(v));
        }, metadata);
        return this;
    };
    AsynchronousMessageBuilder.prototype.withContent = function (contentType, body) {
        this.message.interaction.withBinaryContents(body, contentType);
        this.message.requestIsBinary = true;
        return this;
    };
    AsynchronousMessageBuilder.prototype.withJSONContent = function (content) {
    ...
    AsynchronousMessageBuilder.prototype.withMatchingRules = function (rules) {
...
var AsynchronousMessageWithContent = /** @class */ (function () {
    function AsynchronousMessageWithContent(pact, message, opts, cleanupFn) {
        this.pact = pact;
        this.message = message;
        this.opts = opts;
        this.cleanupFn = cleanupFn;
    }
    AsynchronousMessageWithContent.prototype.executeTest = function (integrationTest) {
        return executeNonTransportTest(this.pact, this.opts, this.message, integrationTest, this.cleanupFn);
    };
    return AsynchronousMessageWithContent;
}());
exports.AsynchronousMessageWithContent = AsynchronousMessageWithContent;
var AsynchronousMessageWithPluginContents = /** @class */ (function () {
    function AsynchronousMessageWithPluginContents(pact, message, opts, cleanupFn) {
        this.pact = pact;
        this.message = message;
        this.opts = opts;
        this.cleanupFn = cleanupFn;
    }
    AsynchronousMessageWithPluginContents.prototype.executeTest = function (integrationTest) {
        return executeNonTransportTest(this.pact, this.opts, this.message, integrationTest, this.cleanupFn);
    };
    AsynchronousMessageWithPluginContents.prototype.startTransport = function (transport, address, // IP Address or hostname
    config) {
...
var AsynchronousMessageWithTransport = /** @class */ (function () {
    function AsynchronousMessageWithTransport(pact, message, opts, port, address, cleanupFn) {
        this.pact = pact;
        this.message = message;
        this.opts = opts;
        this.port = port;
    ...
    AsynchronousMessageWithTransport.prototype.executeTest = function (integrationTest) {
...
var executeNonTransportTest = function (pact, opts, message, integrationTest, cleanupFn) { return __awaiter(void 0, void 0, void 0, function () {
    var val, error, rawInteraction, _a, content, contentType, encoded, m, e_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                rawInteraction = JSON.parse(message.interaction.reifyMessage());
                _a = rawInteraction.contents, content = _a.content, contentType = _a.contentType, encoded = _a.encoded;
                m = {
                    contents: {
                ...
                return [4 /*yield*/, integrationTest(m)];
            case 1:
                val = _b.sent();
                return [3 /*break*/, 3];
            case 2:
