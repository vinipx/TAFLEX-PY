...
export declare class Pact {
    static defaults: PactV2Options;
    static createOptionsWithDefaults(opts: PactV2Options): PactV2OptionsComplete;
    mockService: MockService;
    opts: PactV2OptionsComplete;
     ...
     * @returns {Promise}
     */
    setup(): Promise<PactV2OptionsComplete>;
    /**
