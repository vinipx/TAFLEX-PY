...
export declare function isMatcher(x: unknown): x is MatcherV2<AnyTemplate>;
export type AnyTemplate = AnyJson | MatcherV2<AnyTemplate> | ArrayMatcher<AnyTemplate> | TemplateMap | ArrayTemplate;
 ...
 */
export declare function somethingLike<T>(value: T): MatcherV2<T>;
 ...
 */
export declare function iso8601DateTimeWithMillis(date?: string): MatcherV2<string>;
/**
 * ISO8601 Date matcher.
 * @param {string} date - a basic yyyy-MM-dd date string e.g. 2000-09-31
 */
export declare function iso8601Date(date?: string): MatcherV2<string>;
/**
 ...
 */
export declare function iso8601Time(time?: string): MatcherV2<string>;
/**
 ...
 */
export declare function rfc1123Timestamp(timestamp?: string): MatcherV2<string>;
/**
 * Hexadecimal MatcherV2.
 * @param {string} hex - a hex value.
 */
export declare function hexadecimal(hex?: string): MatcherV2<string>;
/**
 * Decimal MatcherV2.
 * @param {float} float - a decimal value.
 */
export declare function decimal(float?: number): MatcherV2<number>;
/**
 * Integer MatcherV2.
 * @param {integer} int - an int value.
 */
export declare function integer(int?: number): MatcherV2<number>;
/**
 * Boolean MatcherV2.
 */
export declare function boolean(value?: boolean): MatcherV2<boolean>;
/**
 * String MatcherV2.
 */
export declare function string(value?: string): MatcherV2<string>;
