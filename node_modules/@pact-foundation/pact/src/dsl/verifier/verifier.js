...
var Verifier = /** @class */ (function () {
    ...
    Verifier.prototype.runProviderVerification = function () {
        ...
        return function (server) {
            ...
            var opts = __assign(__assign({ providerStatesSetupUrl: "".concat(_this.address, ":").concat(port).concat(_this.stateSetupPath) }, (0, lodash_1.omit)(_this.config, 'handlers')), { providerBaseUrl: "".concat(_this.address, ":").concat(port), transports: (_this.config.transports || []).concat([
                    {
                        port: port,
