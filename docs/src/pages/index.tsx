      ...
      <div className="container">
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroDescription}>
            A modern, enterprise-grade framework powered by Python, the Strategy
...
const coreFeatures = [
  ...
  },
  {
    ...
    description:
      'Built on top of Playwright and Python for maximum performance and reliability on CI/CD pipelines and local development.',
  },
  {
    icon: '📊',
    ...
    <section className={styles.aiAgent}>
      <div className="container">
        <div className={styles.aiContent}>
          ...
          <p>
            TAFLEX PY is the first enterprise framework with native <strong>Model Context Protocol (MCP)</strong> support. 
